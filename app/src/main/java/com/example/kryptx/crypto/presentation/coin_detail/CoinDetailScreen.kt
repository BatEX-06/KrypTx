package com.example.kryptx.crypto.presentation.coin_detail
...
import com.example.kryptx.R
import com.example.kryptx.crypto.presentation.coin_detail.components.InfoCard
import com.example.kryptx.crypto.presentation.coin_list.CoinListState
import com.example.kryptx.crypto.presentation.coin_list.components.previewCoin
import com.example.kryptx.crypto.presentation.models.toDisplayableNumber
import com.example.kryptx.ui.theme.KrypTxTheme
import com.example.kryptx.ui.theme.greenBackground
...
fun CoinDetailScreen(
    ...
    if (state.isLoading){
        ...
        Column(
            ...
            Icon(
                imageVector = ImageVector.vectorResource(id =coin.iconsRes),
...
@PreviewLightDark
@Composable
private fun CoinDetailScreenDataPreview() {
    KrypTxTheme {
        CoinDetailScreen(
            state = CoinListState(
